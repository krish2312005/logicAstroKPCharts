...
namespace logicAstroKPCharts
{
    public partial class BirthDataForm : Form
    {
        ...
        public BirthDataForm(bool loadChartOnShow = false)
        {
            ...
            if (!InitApplication())
            {
                MessageBox.Show("Failed to initialize application components.", "Initialization Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                this.Close();
                return;
            }
        ...
        {
            base.OnShown(e);
            if (m_bLoadChartOnShow)
            {
                m_bLoadChartOnShow = false;
                LoadChartFile();
            }
        }
        ...
        {
            m_strHousingSystem = housingSystem;
        }
